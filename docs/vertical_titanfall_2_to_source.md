...
- [Cra0kalo's Titanfall .vpk Tool](storage/Titanfall_VPKTool3.4_Portable.zip)
...
> *Version 3.4 is linked above, but 3.3, should it be required, can be downloaded [here](storage/Titanfall_VPKTool3.3_Portable.zip).*
