...
- <a href="storage/Titanfall_VPKTool3.4_Portable.zip">Cra0kalo's Titanfall .vpk Tool</a>
...
> *Version 3.4 is linked above, but 3.3, should it be required, can be downloaded <a href="storage/Titanfall_VPKTool3.3_Portable.zip">here</a>.*
